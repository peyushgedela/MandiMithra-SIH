...
import InputField from "../../components/profileinputfield.jsx";
  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      <ScrollView className="p-4">
        {/* Profile Header */}
        <Text className="text-xl font-mbold text-black mb-2 text-center">
          Profile
        </Text>
        <View className="mb-6">
          <View className="flex flex-row items-center justify-center gap-4 my-1">
            <Icon name="user" size={20} color="#000" />
            <Text className="text-lg font-mregular text-black text-center">
              Full Name of the User
            </Text>
          </View>
          <View className="flex flex-row items-center justify-center gap-4 my-1">
            <Icon name="phone" size={20} color="#000" />
            <Text className="text-md font-mregular text-[#676767] text-center">
              +91 XXXXX XXXXX
            </Text>
          </View>
        </View>
        ...
        {/* Personal Details */}
        <Text className="text-lg font-mbold text-black mb-4">
          Personal Details
        </Text>
        ...
        {/* Date of Birth */}
        <View>
          <Text className="text-lg font-mbold text-black mb-2">
            Date of Birth
          </Text>
        ...
        {/* Address Details */}
        <Text className="text-lg font-mbold text-black my-4">
          Address Details
        </Text>

        <DropdownField label="State" placeholder="Select State" />

        <DropdownField label="District" placeholder="Select District" />

        <DropdownField label="Mandal" placeholder="Select Mandal" />
        ...
        <View className="mt-6 mb-10">
          <LandingButton name="Save" color="#D49A42" onPressDestination="/" />
        </View>
      </ScrollView>
    </SafeAreaView>
  );
